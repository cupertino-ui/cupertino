    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-[22px]">Sign in</CardTitle>
          <CardDescription>
            ...
            <FieldGroup>
              ...
              <Field>
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    className="text-[13px] font-medium text-primary no-underline hover:underline underline-offset-4"
                  >
                    Forgot password?
                  </a>
                </div>
              ...
              <Field>
                <Button variant="outline" type="button" className="gap-2.5">
                  <GoogleIcon />
                  Continue with Google
                </Button>
                <FieldDescription className="text-center [&>a]:no-underline [&>a]:text-primary [&>a:hover]:underline">
